...
class _PeoplePageState extends State<Manage> {
  ...
  Future<void> getallmanagersinfo() async {
    var url = Uri.parse('http://192.168.10.7:8000/api/v1/users/getmanagers');
  ...
  Future<void> getallemployeesinfo() async {
    var url = Uri.parse('http://192.168.10.7:8000/api/v1/users/getemployees');
    var response = await http.get(url);
...
class _viewteamState extends State<viewteam> {
  ...
  Future<void> addassignee(sub,sup) async {
          var url = Uri.parse('http://192.168.10.7:8000/api/v1/users/addassignee');
        final response = await http.post(
            url,
...
Future<void> deleterelation(sup,sub) async {
        ...
        var url = Uri.parse('http://192.168.10.7:8000/api/v1/users/deleteassignee');
        final response = await http.post(
            url,
            headers: {'Content-Type': 'application/json'},
            body: jsonEncode({
